...
# 🎯Objectives
Our listed objectives go as follows:
1. Build a firm-year dataset from XBRL indicators.
2. Engineer ratios
3. Use regression models to predict future performance
4. Summarize drivers for decision-making
